...
public class DownloadUtil {
    private final String TAG = DownloadCos.LOG_TAG;
    ...
    public void delete(String urlString) {
        ...
        if (!bool) { // 下载任务不存在，直接删除临时文件
            ...
            Log.e(TAG, "删除当前下载任务:" + file.delete());
        }
    }
