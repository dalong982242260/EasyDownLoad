...
public class TestDemoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urls.add("https://qd.myapp.com/myapp/qqteam/AndroidQQ/mobileqq_android.apk");
        urls.add("http://gdown.baidu.com/data/wisegame/14b5a28ed5d1a997/shoujitaobao_216.apk");
                ...
                if (timer == null) {
                    ...
                    timer.schedule(new TimerTask() {
                        ...
                        public void run() {
                            ...
                            for (Map.Entry<String, DownloadingInfo> entry : downloadingInfos
                                    .entrySet()) {
                                info = entry.getValue();
                                if (info != null) {
    ...
    BaseAdapter myAdapter = new BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Holder holder = null;
            if (convertView == null) {
                convertView = LayoutInflater.from(TestDemoActivity.this).inflate(
        ...
        private void setClick(Holder holder) {
            holder.button_start.setOnClickListener(TestDemoActivity.this);
            holder.button_pause.setOnClickListener(TestDemoActivity.this);
            holder.button_resume.setOnClickListener(TestDemoActivity.this);
            holder.button_delete.setOnClickListener(TestDemoActivity.this);
        }
